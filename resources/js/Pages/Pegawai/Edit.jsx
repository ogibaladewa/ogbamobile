...
export default function Edit(props) {
  ...
  const adminChecked = data.jabatan == "admin" ? "checked" : "";
  const pegawaiChecked = data.jabatan == "pegawai" ? "checked" : "";
  ...
  return (
    <>
      ...
      <div className='w-full min-h-screen bg-[url("../img/dashbg.jpg")] bg-cover bg-fixed'>
        ...
        >
          <InputArea submit={submit} dataName="Pegawai" pageFor="Edit">
