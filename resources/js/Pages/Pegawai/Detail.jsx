...
export default function Detail(props) {
  ...
  const { data, setData, post, processing, errors, reset } = useForm({
    id: props.myPegawai.user_id,
    jabatan: props.myPegawai.jabatan,
    nama: props.myPegawaiUser.nama,
    email: props.myPegawaiUser.email,
    no_hp: props.myPegawaiUser.no_hp,
    tanggal_lahir: props.myPegawaiUser.tanggal_lahir,
    jenis_kelamin: props.myPegawaiUser.jenis_kelamin,
    alamat: props.myPegawaiUser.alamat,
    status: props.myPegawaiUser.status,
    avatar: props.myPegawaiUser.avatar,
  });
  ...
  return (
    <>
      ...
      <div className='w-full min-h-screen bg-[url("../img/dashbg.jpg")] bg-cover bg-fixed'>
        ...
        >
          <DetailArea dataName="Pegawai" pageFor="Detail">
            <div
              className={
                'w-4/12 lg:w-3/12 xl:w-3/12 mx-auto h-0 pt-[35%] lg:pt-[27%] mb-4 border-0 border-black bg-[url("../img/' +
                data.avatar +
                '")] bg-no-repeat bg-contain'
              }
            ></div>
            <div className="w-full lg:w-9/12 grid grid-cols-5 gap-2 mb-4 sm:flex-row items-center mx-auto sm:justify-center text-left">
              <input
                type="hidden"
                id="id"
                name="id"
